...
import { getItemCount } from "@/lib/data/items";
...
export default function WelcomePage() {
  ...
  const stats = [
    { icon: Users, value: "Growing", label: "Student Community", color: "text-blue-500", bg: "bg-blue-500/10" },
    { icon: TrendingUp, value: String(itemCount), label: "Items Listed", color: "text-green-500", bg: "bg-green-500/10" },
    { icon: Shield, value: "Verified", label: "Secure Platform", color: "text-purple-500", bg: "bg-purple-500/10" },
  ];

  const features = [
    { icon: "🔍", title: "Browse & Discover", description: "Find the perfect tools for your courses" },
    { icon: "💰", title: "Earn Money", description: "List your items and start earning" },
    { icon: "🤝", title: "Connect", description: "Chat with fellow students safely" },
    { icon: "⭐", title: "Build Trust", description: "Rate and review your experiences" },
  ];
    ...
    <div className="min-h-screen bg-[#F1F3F5]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-[#1DA5A6] to-[#194774] rounded-full mb-6 shadow-2xl">
          ...
          <p className="text-lg text-[#2C2C2C]/70 max-w-2xl mx-auto mb-8">
            You&apos;re all set! You&apos;re now part of the student marketplace. Let&apos;s get you started on your journey.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-2xl p-6 shadow-md text-center hover:shadow-xl transition-all">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-[#2C2C2C] text-center mb-6">What You Can Do</h2>
              ...
              <div key={index} className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-[#2C2C2C] mb-1">{feature.title}</h3>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#2C2C2C]">Recommended Next Steps</h2>
          </div>
          <div className="space-y-4">
            {nextSteps.map((step, index) => (
              <div key={index} className="flex items-center gap-4 p-4 bg-[#F1F3F5] rounded-xl hover:bg-[#1DA5A6]/5 transition-all group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#2C2C2C]/60">{step.description}</p>
                </div>
        ...
        <div className="bg-gradient-to-r from-[#1DA5A6] to-[#194774] rounded-3xl p-8 text-center text-white shadow-xl">
          ...
          <p className="text-white/80 mb-6 max-w-xl mx-auto">
            Join fellow students already sharing, renting, and saving money on UniTool.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => router.push("/browse")} className="px-8 py-3 bg-white text-[#1DA5A6] rounded-xl font-bold hover:shadow-xl transition-all active:scale-95">
              Browse Items
            </button>
            <button onClick={() => router.push("/list-item")} className="px-8 py-3 bg-white/20 backdrop-blur text-white border-2 border-white/30 rounded-xl font-bold hover:bg-white/30 transition-all active:scale-95">
        ...
        <div className="text-center mt-8">
          <button onClick={() => router.push("/home")} className="text-sm text-[#2C2C2C]/60 hover:text-[#2C2C2C] font-semibold transition-colors flex items-center gap-2 mx-auto">
