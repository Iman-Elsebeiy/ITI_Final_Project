            ...
            {currentStep === 1 && (
              <div className="flex-1 animate-slide-up">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#2C2C2C]/60 text-sm">
                    Choose the university you're currently enrolled in
                  </p>
                </div>
                  ...
                  {universities.map((uni) => (
                    <label
                      ...
                      className={`block p-4 rounded-xl border-2 cursor-pointer transition-all hover:shadow-md ${
                        selectedUniversity === uni
                          ? "border-[#1DA5A6] bg-[#1DA5A6]/5 shadow-md"
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {selectedUniversity === uni && (
                          <CheckCircle2 className="w-5 h-5 text-[#1DA5A6]" />
                        )}
                      </div>
                    </label>
                  ))}
            ...
            {currentStep === 2 && (
              <div className="flex-1 animate-slide-up">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#2C2C2C]/60 text-sm">
                    This helps us show you relevant tools
                  </p>
                </div>
                  ...
                  {majors.map((major) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {selectedMajor === major && (
                          <CheckCircle2 className="w-5 h-5 text-[#1DA5A6] flex-shrink-0" />
                        )}
                      </div>
                    </label>
                  ))}
            ...
            {currentStep === 3 && (
              <div className="flex-1 animate-slide-up">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#2C2C2C]/60 text-sm">
                    How do you plan to use UniTool?
                  </p>
                </div>
                    ...
                    <label
                      ...
                      className={`block p-6 rounded-2xl border-2 cursor-pointer transition-all hover:shadow-lg ${
                        selectedRole === role.id
                          ? "border-[#1DA5A6] bg-gradient-to-br from-[#1DA5A6]/5 to-[#194774]/5 shadow-lg"
                          : "border-[#2C2C2C]/10 hover:border-[#1DA5A6]/30"
                      }`}
                    >
                      <input
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        {selectedRole === role.id && (
                          <CheckCircle2 className="w-6 h-6 text-[#1DA5A6] flex-shrink-0" />
                        )}
                      </div>
                    </label>
                  ))}
            ...
            {currentStep === 4 && (
              <div className="flex-1 animate-slide-up">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#2C2C2C]/60 text-sm">
                    Upload your student ID (Karnay) for verification
                  </p>
                </div>
                ...
                >
                  ...
                  {uploadedFile ? (
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-green-50 border border-green-200 rounded-xl">
                        <p className="text-sm text-green-700 font-medium">
                          ✅ Ready to submit! Click "Complete Setup" below.
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="text-center">
                      ...
                      <p className="text-base font-semibold text-[#2C2C2C] mb-2">
                        Upload Student ID
                      </p>
                ...
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                  <p className="text-xs text-blue-700">
                    <strong>Note:</strong> Your information is secure and will
