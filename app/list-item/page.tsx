...
>>>>>>> a49c62fb27bfe658ddaccd114b6cc174ec32b8da
...
=======
      setUploadedImages((prev) => [...prev, ...filesArray].slice(0, 5));
>>>>>>> a49c62fb27bfe658ddaccd114b6cc174ec32b8da
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="relative border-2 border-dashed border-[#2C2C2C]/20 rounded-xl p-8 hover:border-[#1DA5A6]/50 transition-all">
              ...
              <div className="text-center">
                <Upload className="w-12 h-12 text-[#2C2C2C]/40 mx-auto mb-4" />
                <p className="text-sm font-semibold text-[#2C2C2C] mb-1">Click to upload or drag and drop</p>
                <p className="text-xs text-[#2C2C2C]/60">PNG, JPG up to 10MB (Max 5 photos)</p>
              </div>
            </div>
...
=======
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-xl font-bold text-[#2C2C2C] mb-4 flex items-center gap-2">
            <Package className="w-5 h-5 text-[#1DA5A6]" />Basic Information
          </h2>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Item Title <span className="text-red-500">*</span></label>
              <input type="text" {...register("title", { required: "Title is required", minLength: { value: 5, message: "Title must be at least 5 characters" } })}
                placeholder="e.g., Scientific Calculator TI-84 Plus"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Category <span className="text-red-500">*</span></label>
              <div className="relative">
                <Tag className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#2C2C2C]/40" />
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Description <span className="text-red-500">*</span></label>
              <textarea {...register("description", { required: "Description is required", minLength: { value: 20, message: "Description must be at least 20 characters" } })}
                rows={4} placeholder="Describe your item, its features, and any important details..."
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Condition <span className="text-red-500">*</span></label>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {conditions.map((cond) => (
                  <label key={cond.value} className={`p-3 border-2 rounded-xl cursor-pointer transition-all text-center ${
                    selectedCondition === cond.value ? "border-[#1DA5A6] bg-[#1DA5A6]/5" : "border-[#2C2C2C]/10 hover:border-[#1DA5A6]/30"}`}>
                    <input type="radio" value={cond.value} {...register("condition", { required: "Condition is required" })} className="sr-only" />
                    <div className="text-2xl mb-1">{cond.emoji}</div>
                    <p className="text-xs font-semibold text-[#2C2C2C]">{cond.label}</p>
                  </label>
                ))}
              </div>
...
=======
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="number" {...register("price", { required: "Price is required", min: { value: 1, message: "Price must be at least 1 EGP" } })}
                  placeholder="50" className={`w-full h-12 pl-16 pr-4 bg-[#F1F3F5] rounded-xl text-sm text-[#2C2C2C] placeholder:text-[#2C2C2C]/40 focus:outline-none focus:ring-2 transition-all ${errors.price ? "ring-2 ring-red-500" : "focus:ring-[#1DA5A6]/30"}`} />
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-xl font-bold text-[#2C2C2C] mb-4 flex items-center gap-2">
            <Calendar className="w-5 h-5 text-[#1DA5A6]" />Availability & Location
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Available From</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Pickup Location <span className="text-red-500">*</span></label>
              <div className="relative">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#2C2C2C]/40" />
                <input type="text" {...register("location", { required: "Location is required" })} placeholder="e.g., Main Campus, Building 5"
