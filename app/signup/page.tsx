    ...
    <div className="min-h-screen bg-[#F1F3F5] py-8 px-4">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#2C2C2C] mb-2">Create Your Account</h2>
          <p className="text-[#2C2C2C]/60 text-sm">Join the student marketplace community</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-[#2C2C2C]/40 font-medium">or sign up with email</span>
            <div className="flex-1 h-px bg-[#2C2C2C]/10" />
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-14 pl-12 pr-4 bg-[#F1F3F5] rounded-xl text-sm text-[#2C2C2C] placeholder:text-[#2C2C2C]/40 focus:outline-none focus:ring-2 transition-all ${
                    errors.fullName ? "ring-2 ring-red-500" : "focus:ring-[#1DA5A6]/30"
                  }`}
                />
              </div>
              {errors.fullName && (
                <p className="text-red-500 text-xs mt-1.5 ml-1">{errors.fullName.message}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className={`w-full h-14 pl-12 pr-4 bg-[#F1F3F5] rounded-xl text-sm text-[#2C2C2C] focus:outline-none focus:ring-2 transition-all appearance-none cursor-pointer ${
                      errors.university ? "ring-2 ring-red-500" : "focus:ring-[#1DA5A6]/30"
                    }`}
                  >
                ...
                {errors.university && (
                  <p className="text-red-500 text-xs mt-1.5 ml-1">{errors.university.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className={`w-full h-14 pl-12 pr-4 bg-[#F1F3F5] rounded-xl text-sm text-[#2C2C2C] focus:outline-none focus:ring-2 transition-all appearance-none cursor-pointer ${
                      errors.faculty ? "ring-2 ring-red-500" : "focus:ring-[#1DA5A6]/30"
                    }`}
                  >
                ...
                {errors.faculty && (
                  <p className="text-red-500 text-xs mt-1.5 ml-1">{errors.faculty.message}</p>
                )}
              </div>
            </div>
              ...
              >
                ...
                {uploadedFile ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm font-semibold text-[#2C2C2C] mb-1">Upload Student ID</p>
                    <p className="text-xs text-[#2C2C2C]/60">PNG, JPG or PDF (max. 5MB)</p>
                  </div>
                )}
              </div>
              {errors.studentId && (
                <p className="text-red-500 text-xs mt-1.5 ml-1">{errors.studentId.message}</p>
              )}
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full h-14 pl-12 pr-12 bg-[#F1F3F5] rounded-xl text-sm text-[#2C2C2C] placeholder:text-[#2C2C2C]/40 focus:outline-none focus:ring-2 transition-all ${
                      errors.confirmPassword ? "ring-2 ring-red-500" : "focus:ring-[#1DA5A6]/30"
                    }`}
                  />
                  <button
                    type="button"
            ...
            <div className="flex items-start gap-3 p-4 bg-[#F1F3F5] rounded-xl">
              ...
              <label className="text-sm text-[#2C2C2C]/70 leading-relaxed">
                ...
                <Link href="/terms" className="text-[#1DA5A6] font-semibold hover:underline">Terms of Service</Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-[#1DA5A6] font-semibold hover:underline">Privacy Policy</Link>
              </label>
            </div>
            {errors.agreeToTerms && (
              <p className="text-red-500 text-xs ml-1 -mt-3">{errors.agreeToTerms.message}</p>
            )}
