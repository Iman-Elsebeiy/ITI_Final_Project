module.exports = [
"[project]/app/auth/data:e3c554 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$auth$2f$data$3a$e3c554__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/auth/data:e3c554 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        setAuthError(null);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$auth$2f$data$3a$e3c554__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["login"])({
            email: data.email,
...
//# sourceMappingURL=app_0o2--8o._.js.map